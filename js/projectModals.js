            ...
            '<div class="row justify-content-center">' +
              '<div class="col-lg-8">' +
                ...
                '<div class="divider-custom">' +
                  ...
                  '<div class="divider-custom-line"></div>' +
                '</div>' +
                '<img class="img-fluid rounded mb-5" src="img/projects/screenshots/' + project.imageUrl + '" alt="' + project.name + '">' +
...
function getProjects() {
  return [
    	...
    	},
      {
        ...
        "description": "Okay pill is a clothing brand built around mental health awareness. As a friend of the founder, I volunteered to build their website per his designs. The website is built in NodeJS using React.",
    		"technologies": "React",
